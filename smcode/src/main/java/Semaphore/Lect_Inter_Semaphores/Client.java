package Semaphore.Lect_Inter_Semaphores;
...
public class Client {
    public static void main(String[] args) {
        //linked list used here is causing problem because LL won't support
        //concurrency, so here need to use some concurrent DS
